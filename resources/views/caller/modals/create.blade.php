    ...
    <div class="modal fade" id="callerConfigModal" tabindex="-1" aria-labelledby="callerConfigModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form id="websocketForm" method="POST" action="{{ route('caller.caller.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        class="form-control @error('websocket_port') is-invalid @enderror"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control @error('websocket_path') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control @error('sip_full_name') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sip_domain') is-invalid @enderror"
                                        ...
                                        value="{{ old('sip_domain', $caller->sip_domain) }}"
                                        placeholder="Enter SIP domain" required>
                                    @error('sip_domain')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="user_id" class="form-label text-danger">Select User *</label>
                                    <select class="form-control @error('user_id') is-invalid @enderror" id="user_id"
                                        name="user_id" required>
                                        <option value="">Select a user</option>
                                        @foreach ($users as $id => $name)
                                            <option value="{{ $id }}"
                                                {{ old('user_id', $caller->user_id) == $id ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mt-4 text-end">
                            ...
                            <button type="submit" class="btn btn-danger" id="syncButton">Save</button>
                        </div>
                    </form>
                </div>
            </div>
